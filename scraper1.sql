...
CREATE TABLE `html_url1` (
  ...
  PRIMARY KEY (`counter`),
  UNIQUE KEY `rss` (`url`)
) ENGINE=InnoDB AUTO_INCREMENT=10487013 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rss_feedage` (
  ...
  `checked2` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`counter`)
) ENGINE=InnoDB AUTO_INCREMENT=18849553 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rss_url` (
  ...
  PRIMARY KEY (`counter`),
  UNIQUE KEY `rss` (`rss`)
) ENGINE=InnoDB AUTO_INCREMENT=329424 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rss_xml_parse` (
  ...
  PRIMARY KEY (`counter`),
  UNIQUE KEY `url` (`url`)
) ENGINE=InnoDB AUTO_INCREMENT=222205 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-06-02  0:07:42
