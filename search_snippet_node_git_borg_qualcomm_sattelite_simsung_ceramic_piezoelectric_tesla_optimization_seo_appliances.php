...
// mysqldump -u root -p3h4xb0011011001tCiK scraper rss_xml_parse --where="timestamp BETWEEN '2017-07-13' and '2017-07-14'" > 2017-07-13.sql

//php /var/www/html/search.php acquire >  /var/www/html/search/2017-07-14/acquire1.html&
$term = $word;
$span = 3;
//print_r($matches);
