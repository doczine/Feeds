...
require '/home/rss/predis/examples/shared.php';
...
$count = namefile();
		...
		if ($stmt = mysqli_prepare($conn, "INSERT IGNORE INTO `scraper`.`rss_xml_parse` (`url`, `title`, `timestamp`, `description`, `checked`) VALUES (?,?,?,?,?)")); {
